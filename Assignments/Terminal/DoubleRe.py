...
Decription: This is the >> redirect command. Like all my commands it takes a waspiped argument to indicated if it was piped and should
...
exist we create the file if not we append to the existing file. We then check if the input is a string or a list and if it is a list we write
...
'''
import os
def doublere(wasPiped=None, *args):
	import os
	pipeOrRe = False
	inputt = None
	file = None
